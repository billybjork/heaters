...
`);
  ...
  var SplitManager = {
    ...
    enter(player, btn) {
      ...
      btn == null ? void 0 : btn.classList.add("split-armed");
    ...
    exit() {
      ...
      (_a2 = this.btnEl) == null ? void 0 : _a2.classList.remove("split-armed");
  ...
  var SpritePlayerController = {
    mounted() {
      ...
      splitBtn == null ? void 0 : splitBtn.addEventListener("click", () => {
  ...
  var SpritePlayer = class {
    ...
    _setupUI() {
      ...
      if (this.speedBtn) {
        ...
        this.speedBtn.textContent = `${this.speeds[this.speedIndex]}\xD7`;
      }
    }
    /* event listeners ----------------------------------------------------- */
    ...
    _cycleSpeed() {
      ...
      this.speedBtn.textContent = `${rate}\xD7`;
    ...
    play() {
      ...
      this.isPlaying = true;
      this.playPauseBtn.textContent = "\u23F8";
      const interval = 1e3 / (this.meta.clip_fps * this.speeds[this.speedIndex]);
      const last = this.meta.clip_total_frames - 1;
  ...
  var ReviewHotkeys = {
    mounted() {
      ...
      this._onKeyDown = (e) => {
        ...
        if (this.keyMap[k] && !this.armed) {
          ...
          (_a2 = this.btn) == null ? void 0 : _a2.classList.add("is-armed");
          e.preventDefault();
          return;
        }
        if (e.key === "Enter") {
          ...
          if (this.armed) {
            ...
            if (this.idMode && this.idBox && this.idBox.value.trim() !== "" && (action === "merge" || action === "group")) {
    ...
    _reset() {
      var _a2;
      (_a2 = this.btn) == null ? void 0 : _a2.classList.remove("is-armed");
