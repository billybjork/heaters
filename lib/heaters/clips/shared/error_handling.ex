defmodule Heaters.Clips.Shared.ErrorHandling do
  @moduledoc """
  ...
  Used by all operation modules for consistent error handling:
      ...
      Shared.ErrorHandling.mark_failed(clip_id, "virtual_operation_failed", error_reason)

      # From artifact operations
      Shared.ErrorHandling.mark_failed(clip_id, "keyframe_failed", "FFmpeg error")

      # From export operations
      Shared.ErrorHandling.mark_failed(clip_id, "export_failed", {:s3_error, "Upload timeout"})
  """
  ...
  ## Examples
      ...
      Shared.ErrorHandling.mark_failed(clip_id, "keyframe_failed", "OpenCV initialization error")

      # Mark export operation as failed
      Shared.ErrorHandling.mark_failed(clip, "export_failed", {:ffmpeg_error, "Invalid codec"})

      # Mark virtual clip operation as failed
      Shared.ErrorHandling.mark_failed(clip_id, "virtual_operation_failed", "MECE validation error")
  """
