defmodule Heaters.Clips.Artifacts.Keyframe do
  @moduledoc """
  ...
  alias Heaters.Clips.Artifacts.Keyframe.{Strategy, Validation}
  alias Heaters.Clips.Shared.{ResultBuilding, ErrorFormatting}
