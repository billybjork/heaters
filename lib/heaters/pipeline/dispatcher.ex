defmodule Heaters.Pipeline.Dispatcher do
  @moduledoc """
  Pipeline dispatcher – orchestrates stage transitions.

  This module coordinates the execution of all pipeline stages using
  declarative configuration. It runs as a scheduled job to check for
  items that need processing and enqueue appropriate worker jobs.
  """
