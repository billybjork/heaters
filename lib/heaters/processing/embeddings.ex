defmodule Heaters.Processing.Embeddings do
  @moduledoc """
  ...
  - `Heaters.Processing.Embeddings.Search` for similarity search and discovery
  - `Heaters.Processing.Embeddings.Workflow` for state management and embedding workflow
  - `Heaters.Processing.Embeddings.Types` for shared type definitions
  """

  alias Heaters.Processing.Embeddings.Search
