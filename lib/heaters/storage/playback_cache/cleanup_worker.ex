defmodule Heaters.Storage.PlaybackCache.CleanupWorker do
  ...
  def perform(%Oban.Job{}) do
    ...
    try do
      ...
      stats = %{
        ...
        lru_evicted: enforce_cache_limits(cache_size),
  ...
  """
  @spec enforce_cache_limits(non_neg_integer() | nil) :: non_neg_integer()
  def enforce_cache_limits(current_size \\ nil) do
    current_size = current_size || get_cache_size()
