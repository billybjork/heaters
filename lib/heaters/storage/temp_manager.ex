defmodule Heaters.Storage.TempManager do
  @moduledoc """
  ...
  @doc """
  Download a file for processing to a temporary directory.

  Downloads a file from S3 to a local temporary directory for processing.

  ## Parameters
  - `filepath`: The S3 key or file path to download
  - `operation`: The operation name for temp directory naming
