defmodule Heaters.Workers.Dispatcher do
  ...
  alias Heaters.Clips
  alias Heaters.Workers.IntakeWorker
  alias Heaters.Workers.SpriteWorker
  alias Heaters.Workers.KeyframeWorker
  alias Heaters.Workers.ArchiveWorker
  ...
  def perform(_job) do
    ...
    spliced_clips = Clips.get_clips_by_state("spliced")
