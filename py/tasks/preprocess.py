...
def run_preprocess(source_video_path: str, source_video_id: int, video_title: str,
                  master_output_path: str, proxy_output_path: str, 
    ...
    Args:
        source_video_path: Local path to source video (from temp cache)
        source_video_id: Database ID of the source video
        video_title: Title for logging/metadata
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Use S3 paths provided by Elixir (eliminates path generation coupling)
            master_s3_key = master_output_path
            proxy_s3_key = proxy_output_path
